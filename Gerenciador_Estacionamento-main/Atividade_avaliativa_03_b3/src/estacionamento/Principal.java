...
public class Principal {
    ...
    private static int calcularHorasDePermanencia(Veiculo veiculo) {
    	...
    	System.out.println("Quantos tempo o Carro ficou: ");
    	System.out.println("Menos De uma Hora digite: [1]");
    	System.out.println("Entre 1 a 3 Horas digite: [2]");
    	System.out.println("Mais De 3 Horas digite:   [3]");
    ...
    private static int calcularValor(int horas) {
    	System.out.println("Quantas horas Ficou: ");
    	int num = scan.nextInt();
